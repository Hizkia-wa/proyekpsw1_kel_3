...
import lt2 from "../images/lt2.jpg";
import lt3 from "../images/lt3.jpg";
import lt4 from "../images/lt4.png";
import lt5 from "../images/lt5.png";
import lt6 from "../images/lt6.png";
import lt7 from "../images/lt7.png";
import lt8 from "../images/lt8.png";
import lt9 from "../images/lt9.png";
import lt10 from "../images/lt10.webp";
    ...
    <div>
      <header className="header">
        <div className="header-content">
          <h1>Pengertian Limit Fungsi Trigonometri</h1>
      ...
      <section className="tech-news">
        ...
        <img src={lt} alt="limit trigonometri" />
        </div>
      </section>
      ...
      <section className="tech-news2">
        ...
        <div className="news-image">
        <img src={lt2} alt="limit trigonometri" />
        </div>
      </section>
      ...
      <section className="tech-news3">
        ...
        <div className="news-image">
        <img src={lt3} alt="limit trigonometri" />
        </div>
      </section>
      ...
      <section className="future-work">
        ...
        <div className="cards">
          <div className="card">
            <p>Sine (sin)</p>
            <img src={lt4} alt="limit trigonometri" />
          </div>
          <div className="card">
            <p>Cosine (cos)</p>
            <img src={lt5} alt="limit trigonometri" />
          </div>
          <div className="card">
            <p>Tangent (tan)</p>
            <img src={lt6} alt="limit trigonometri" />
          </div>
        </div>
      </section>
      ...
      <section className="future-work">
        <div className="cards">
          <div className="card">
            <p>Cosecant (csc)</p>
            <img src={lt7} alt="limit trigonometri" />
          </div>
          <div className="card">
            <p>secant (sec)</p>
            <img src={lt8} alt="limit trigonometri" />
          </div>
          <div className="card">
            <p>Cotangent (cot)</p>
            <img src={lt9} alt="limit trigonometri" />
          </div>
        </div>
      </section>
      ...
      <section className="tech-news5">
        ...
        <div className="news-image">
        <img src={lt10} alt="limit trigonometri" />
        </div>
      </section>
    </div>
  );
