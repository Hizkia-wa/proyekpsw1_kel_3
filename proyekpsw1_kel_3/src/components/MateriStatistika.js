...
const MateriStatistika = () => {
  const sections = [
    { 
      ...
      content: "Statistika adalah cabang ilmu yang mempelajari cara mengumpulkan, mengolah, dan menganalisis data.", 
      bgImage: stk1
    },
    { 
      id: 2, 
      title: "Populasi dan Sampel", 
      content: "Populasi adalah keseluruhan objek yang diteliti, sedangkan sampel adalah bagian dari populasi.", 
      bgImage: stk2
    },
    { 
      id: 3, 
    ...
    { 
      ...
      content: "Pengukuran data meliputi skala nominal, ordinal, interval, dan rasio.", 
      bgImage: stk4
    },
    { 
      id: 5, 
      title: "Distribusi Data", 
      content: "Distribusi data menunjukkan bagaimana data tersebar, contohnya distribusi normal.", 
      bgImage: stk5
    },
    { 
      id: 6, 
      title: "Statistika Deskriptif", 
      content: "Statistika deskriptif melibatkan perhitungan mean, median, modus, dan penyajian data.", 
      bgImage: stk6
    },
    { 
      id: 7, 
      title: "Statistika Inferensial", 
      content: "Statistika inferensial digunakan untuk membuat prediksi atau kesimpulan berdasarkan sampel.", 
      bgImage: stk7
    },
    { 
      id: 8, 
      title: "Penerapan Statistika", 
      content: "Statistika banyak digunakan di bidang ekonomi, kesehatan, pendidikan, dan teknologi.", 
      bgImage: stk8
    },
  ];
